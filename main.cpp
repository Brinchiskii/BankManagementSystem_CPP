...
int main() {
    ...
    */
    ...
    //employee->createNewCustomerUser("alex9601", "test_password_alex");
    //employee->createNewCustomer("A123456943", 500000, "Alexander.fadamsen@gmail.com", 22, "Alexander", "Adamsen");
    //employee->printAllCustomerAccounts();
